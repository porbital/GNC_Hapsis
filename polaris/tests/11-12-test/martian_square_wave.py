...
try:
    ...
    with open(filename, "w") as file:
        file.write(f"Martian Square Wave Test Log, {square_wave_period}\n")
        file.write("Time, DeltaT,Angular Position,R Solenoid,L Solenoid,Angular Vel X,Angular Vel Y,Angular Vel Z,PID Error,P\n")
    ...
    while True:
        ...
        try:
            ...
            with open(filename, "a") as file:
                file.write(
                    f"{time_since_start},{delta_time},{current_heading},{int(negative_thruster_on)},{int(positive_thruster_on)},{gyro_x},{gyro_y},{gyro_z},{output},{error}\n"
                )
